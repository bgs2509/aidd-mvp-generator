...
**Решение**: CLAUDE.md целевого проекта (генерируется `/init`) содержит:
- Таблицу всех доступных команд с описанием ворот
- Инструкции для AI по загрузке полных инструкций из submodule
- Порядок чтения файлов при выполнении команды
