...
| Артефакт | Путь |
|----------|------|
| QA отчёт | `ai-docs/docs/reports/{YYYY-MM-DD}_{FID}_{slug}-qa.md` |
...
filename = f"{date}_{fid}_{slug}-qa.md"
...
## Чеклист ворот QA_PASSED

> ⚠️ AI ОБЯЗАН создать TodoWrite с этими пунктами.

- [ ] 🔴 Все тесты проходят (0 failed)
- [ ] 🔴 Coverage ≥ 75%
- [ ] 🔴 **QA Report создан** (`ai-docs/docs/reports/{name}-qa.md`)
- [ ] 🔴 `.pipeline-state.json` обновлён (gate: QA_PASSED)
