...
- Анализ существующих тестов и выявление gaps (FEATURE)
...
- Существующие тесты (smoke/unit/integration/e2e)
...
- Покрытие тестами по категориям и пробелы относительно PRD секции 6.5
