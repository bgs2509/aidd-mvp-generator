...
Дополнительно зафиксировать требования к тестированию:
- **Smoke тесты** — всегда обязательны (TRQ-001..TRQ-004)
- **Unit/Integration/E2E** — спросить пользователя, нужны ли они
- **Порог покрытия** — по умолчанию ≥75%, уточнить при необходимости
...
Создать документ `ai-docs/docs/_analysis/{name}-prd.md` (в целевом проекте) используя шаблон:
...
- [ ] PRD файл создан в `ai-docs/docs/_analysis/` (целевой проект)
...
Файл `ai-docs/docs/_analysis/booking-restaurant-prd.md` (в целевом проекте) с:
