...
- `.claude/commands/init.md` — добавлена секция "4. Копирование slash-команд"
- `.claude/commands/init.md` — обновлён вывод (NEW_PROJECT и EXISTING_PROJECT)
- `CLAUDE.md` — обновлён раздел "Особенности работы с командами"
