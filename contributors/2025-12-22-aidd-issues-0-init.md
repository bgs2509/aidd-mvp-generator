...
|---|-------|------|-----------|--------|
| 1 | BOOTSTRAP_READY отсутствует в шаблоне | `pipeline-state-template.json` | Средний | ✅ Исправлено |
| 2 | current_stage = 1 вместо 0 | `pipeline-state-template.json` | Низкий | ✅ Исправлено |
| 3 | /init не проверяет лишние файлы | `init.md` | Средний | ✅ Исправлено |

---

## Исправления (2025-12-22)

### Issue #1 + #2: pipeline-state-template.json
- Добавлен `BOOTSTRAP_READY` как первые ворота в `gates`
- Изменён `current_stage`: `1` → `0`

### Issue #3: init.md
- Добавлена секция "Проверка существующих файлов"
- Реализована блокирующая проверка `requires-python >= 3.13`
- Добавлены предупреждения для заглушек и lock-файлов

---

*Файл создан автоматически во время выполнения `/init`*
*Обновлён: 2025-12-22 — все issues исправлены*
