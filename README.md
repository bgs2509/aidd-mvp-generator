...
# /aidd-init → /aidd-idea → /aidd-research → /aidd-plan → /aidd-generate → /aidd-review → /aidd-test → /aidd-validate → /deploy
...
│         │    │ ВАНИЕ   │    │  ТУРА   │    │   ЦИЯ   │
│ /aidd-idea   │    │/research│    │ /aidd-plan   │    │/generate│
└────┬────┘    └────┬────┘    └────┬────┘    └────┬────┘
     │              │              │              │
┌────▼────┐    ┌────▼────┐    ┌────▼────┐    ┌────▼────┐
...
│         │    │         │    │   ЦИЯ   │    │         │
│ /aidd-review │    │  /aidd-test  │    │/validate│    │ /aidd-deploy │
└────┬────┘    └────┬────┘    └────┬────┘    └────┬────┘
     │              │              │              │
┌────▼────┐    ┌────▼────┐    ┌────▼────┐    ┌────▼────┐
